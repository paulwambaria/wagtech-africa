                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", paddingTop: "14px", borderTop: "1px solid #E5E5E5", alignItems: "center" }}>
                          ...
                          {product.resources.map((r) => (
                            <a key={r.type} href={r.url}
                              style={{ fontSize: "11px", fontWeight: 600, padding: "6px 12px", borderRadius: "8px", textDecoration: "none", background: r.type === "Brochure" ? "#800000" : "#F8F8F8", color: r.type === "Brochure" ? "#fff" : "#6B7280", border: r.type === "Brochure" ? "none" : "1px solid #E5E5E5" }}>
                              {r.label}
                            </a>
                          ))}
                          <Link href="/contact"

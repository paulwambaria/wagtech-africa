                      ...
                      <div style={{ padding: "24px", flex: 1, display: "flex", flexDirection: "column" }}>
                        ...
                        <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "7px", marginBottom: "16px" }}>
                          {product.features.slice(0, 3).map((f) => (
                            <li key={f} style={{ display: "flex", alignItems: "flex-start", gap: "8px", fontSize: "12.5px", color: "#6B7280" }}>
                              <div style={{ width: "14px", height: "14px", borderRadius: "50%", background: "rgba(128,0,0,0.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "1px" }}>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", paddingTop: "14px", borderTop: "1px solid #E5E5E5", alignItems: "center" }}>
                          <Link href={`/products/${product.slug}`}
                            style={{ display: "inline-flex", alignItems: "center", gap: "5px", fontSize: "11px", fontWeight: 600, padding: "6px 12px", borderRadius: "8px", textDecoration: "none", background: "rgba(128,0,0,0.06)", color: "#800000", border: "1px solid rgba(128,0,0,0.2)" }}>
                            Read More
                          ...
                          {product.resources.map((r) => (
                            <a key={r.type} href={r.url} style={{ fontSize: "11px", fontWeight: 600, padding: "6px 12px", borderRadius: "8px", textDecoration: "none", background: r.type === "Brochure" ? "#800000" : "#F8F8F8", color: r.type === "Brochure" ? "#fff" : "#6B7280", border: r.type === "Brochure" ? "none" : "1px solid #E5E5E5" }}>
                              {r.label}
                            </a>
                          ))}

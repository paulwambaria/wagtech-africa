    ...
    return (
      <div style={{ minHeight: "100svh", display: "flex", alignItems: "center", justifyContent: "center", paddingTop: "100px" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <Link href="/blog" style={{ color: "#800000", fontWeight: 600, textDecoration: "none" }}>← Back to Blog</Link>
        </div>
      </div>
    );
  }
    ...
    <>
      <PageBanner image="/images/gallery/10.jpg">
        <div className="wrap" style={{ position: "relative", zIndex: 1 }}>
          <Link href="/blog" style={{ color: "#800000", fontSize: "13px", fontWeight: 600, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px", marginBottom: "24px" }}>
      ...
      <section className="section" style={{ background: "#fff" }}>
        <div className="wrap" style={{ maxWidth: "800px", marginLeft: "auto", marginRight: "auto" }}>
          ...
          <div style={{ height: "280px", background: "linear-gradient(135deg, #181818 0%, #0D0D0D 100%)", borderRadius: "16px", marginBottom: "44px", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", position: "relative" }}>
            <div style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 30% 50%, rgba(128,0,0,0.3) 0%, transparent 65%)" }} />
          ...
          <div style={{ marginTop: "44px", background: "#F8F8F8", borderRadius: "16px", padding: "28px", borderLeft: "3px solid #800000" }}>

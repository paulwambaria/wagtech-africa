                  ...
                  <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "8px" }}>
                    {svc.features.map((f) => (
                      <li key={f} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "13px", color: "#6B7280" }}>
                        <div style={{ width: "16px", height: "16px", borderRadius: "50%", background: "rgba(128,0,0,0.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                          <svg width="8" height="8" viewBox="0 0 20 20" fill="none" stroke="#800000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M4 10l4.5 4.5L16 6"/></svg>
                        </div>
                        {f}
                      </li>
                    ))}
          ...
          <div className="ts-expertise-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: "12px", marginBottom: "36px" }}>
            {expertise.map((exp) => (
              <div key={exp.title} className="card-dark" style={{ padding: "24px", textAlign: "center" }}>
                <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "rgba(128,0,0,0.1)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 14px" }}>
          ...
          <div className="ts-process-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "14px" }}>
            {[
              ...
              <div key={step.step} className="card-light" style={{ padding: "28px" }}>
                <div style={{ fontFamily: "var(--font-jakarta, 'Plus Jakarta Sans', system-ui, sans-serif)", fontWeight: 900, fontSize: "2rem", color: "#800000", lineHeight: 1, marginBottom: "12px" }}>
                  {step.step}
                </div>
